...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    delete_button = gui.button_design(frame, 1621, 857, 118, 40, "pink", "white", "DELETE", ("Century Gothic", 13))
    delete_button.config(command=deleteData)
    cancel_button = gui.button_design(frame, 1756, 857, 118, 40, "black", "white", "CANCEL", ("Century Gothic", 13))
