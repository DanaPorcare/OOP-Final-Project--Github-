...
# ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    log_out_button = gui.button_design(frame, 2, 1001, 259, 79, "green", "white", "  Log Out",("Century Gothic", 12, 'bold'))
    ...
    delete_button = gui.button_design(frame, 1621, 857, 118, 40, "black", "white", "DELETE", ("Century Gothic", 13))
    delete_button.config(command=deleteData)
    cancel_button = gui.button_design(frame, 1756, 857, 118, 40, "yellow", "white", "CANCEL", ("Century Gothic", 13))
